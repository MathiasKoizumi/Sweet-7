			...
			for (int num = 15; num >= 0; num--)
			{
				...
				for (int num2 = trælle.getJohn().Count - 1; num2 > 0; num2--)
				{
					...
					case 2:
						...
						break;
					case 3:
						graphics.DrawLine(new Pen(new SolidBrush(Color.FromArgb(50, 0, 0, 0))), junkie.Next(900), junkie.Next(700), junkie.Next(900), junkie.Next(700));
						graphics.DrawLine(new Pen(new SolidBrush(Color.FromArgb(50, 0, 0, 0))), junkie.Next(900), junkie.Next(10), junkie.Next(100) + 800, junkie.Next(10) + 700);
						graphics.DrawLine(new Pen(new SolidBrush(Color.FromArgb(50, 0, 0, 0))), junkie.Next(10), junkie.Next(10), junkie.Next(800) + 10, junkie.Next(10) + 700);
						graphics.DrawLine(new Pen(new SolidBrush(Color.FromArgb(50, 0, 0, 0))), 450, 350, junkie.Next(900), junkie.Next(700));
						break;
					case 4:
					...
					case 5:
					{
						...
						if (tookie < 0)
						{
							...
							for (int j = 0; j < 20; j++)
							{
								graphics.FillEllipse(new SolidBrush(Color.FromArgb(junkie.Next(60) + 100, junkie.Next(25) + 230, junkie.Next(25) + 230, junkie.Next(25) + 230)), new Rectangle(junkie.Next(100) + num3, junkie.Next(50) + num3, junkie.Next(1000) + num4, junkie.Next(1000) + num4));
							}
						}
						break;
					}
				...
				if (junkie.Next(abli) > 1000)
				{
					graphics.DrawImage(image2, (int)(200.0 * Math.Sin(junkie.Next(10000))) + 200, 50 + (int)(200.0 * Math.Sin(junkie.Next(10000))));
				}
				if (junkie.Next(ibli) > 40)
				{
					graphics.DrawImage(image, new Rectangle(new Point(400 + (int)(100.0 * Math.Sin(junkie.Next(10000))), 350 + (int)(200.0 * Math.Sin(junkie.Next(10000)))), new Size(new Point(100 + (int)(50.0 * Math.Sin(junkie.Next(10000))), 150 + (int)(50.0 * Math.Sin(junkie.Next(10000)))))));
				}
			}
		}
